...
* Latest JSON-LD @context : https://test.uncefact.org/vocabulary/untp/dpp/0/3/6/untp-dpp-context.jsonld
* Latest JSON Schema : https://test.uncefact.org/vocabulary/untp/dpp/0/3/6/untp-dpp-schema.json 
* Example DPP : [untp-digital-product-passport-v0.3.6 (battery use case)](../../samples/untp-digital-product-passport-v0.3.6.json)
...
| 0.3.6 | 22-08-2024| Draft | Consistency enhancements. Ready for pilot testing | [@context](https://test.uncefact.org/vocabulary/untp/dpp/0/3/6/untp-dpp-context.jsonld) | [schema](https://test.uncefact.org/vocabulary/untp/dpp/0/3/6/untp-dpp-schema.json)|
...
The [DPP documentation](https://jargon.sh/user/unece/DigitalProductPassport/v/0.3.5/artefacts/readme/render) provides a technology-neutral definition of classes, properties and code lists in the DPP model.
