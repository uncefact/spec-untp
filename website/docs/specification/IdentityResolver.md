...
### Working with DIDs
[Decentralized Identifiers]([url](https://www.w3.org/TR/did-1.0/)) (DIDs) have features that match the UNTP requirements in a slightly different way. They are unique, discoverable, resolvable and verifiable, and can be resolved to a set of links to related information. In that regard, the concepts are exactly the same as described above. However, the terminology and methodology differ.
