...
For participants less familiar with GitHub tools and processes, there is a [guidance page](usingGitHub) on how to write content and how to request changes via the pull request workflow. 
